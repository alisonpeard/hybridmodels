...
<qgis simplifyDrawingTol="1" minScale="100000000" version="3.20.3-Odense" readOnly="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" maxScale="0" simplifyMaxScale="1">
  <flags>
  ...
  <temporal enabled="0" endExpression="" accumulate="0" durationField="" fixedDuration="0" durationUnit="min" startField="" mode="0" startExpression="" endField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 type="graduatedSymbol" symbollevels="0" graduatedMethod="GraduatedColor" forceraster="0" attr="left" enableorderby="0">
    <ranges>
      <range lower="0.000000000000000" symbol="0" render="true" upper="700.124286528211087" label="0 - 700"/>
      <range lower="700.124286528211087" symbol="1" render="true" upper="2020.476333480727590" label="700 - 2020"/>
      <range lower="2020.476333480727590" symbol="2" render="true" upper="3754.161423230215860" label="2020 - 3754"/>
      <range lower="3754.161423230215860" symbol="3" render="true" upper="6046.252579546916422" label="3754 - 6046"/>
      <range lower="6046.252579546916422" symbol="4" render="true" upper="13099.372593784190030" label="6046 - 13099"/>
    </ranges>
    <symbols>
      ...
      <symbol type="marker" alpha="1" force_rhr="0" clip_to_extent="1" name="2">
        ...
        <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
          ...
          <prop k="angle" v="0"/>
          <prop k="cap_style" v="square"/>
          <prop k="color" v="115,178,216,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol type="marker" alpha="1" force_rhr="0" clip_to_extent="1" name="3">
        ...
        <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
          ...
          <prop k="angle" v="0"/>
          <prop k="cap_style" v="square"/>
          <prop k="color" v="200,220,240,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol type="marker" alpha="1" force_rhr="0" clip_to_extent="1" name="4">
        ...
        <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="247,251,255,255"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="name" value="circle"/>
            <Option type="QString" name="offset" value="0,0"/>
    ...
    <colorramp type="gradient" name="[source]">
      <Option type="Map">
        <Option type="QString" name="color1" value="8,48,107,255"/>
        <Option type="QString" name="color2" value="247,251,255,255"/>
        <Option type="QString" name="discrete" value="0"/>
        <Option type="QString" name="rampType" value="gradient"/>
        <Option type="QString" name="stops" value="0.1;8,81,156,255:0.22;33,113,181,255:0.35;66,146,198,255:0.48;107,174,214,255:0.61;158,202,225,255:0.74;198,219,239,255:0.87;222,235,247,255"/>
      </Option>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundColor="#ffffff" scaleDependency="Area" lineSizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" width="15" minimumSize="0" spacingUnitScale="3x:0,0,0,0,0,0" height="15" maxScaleDenominator="1e+08" enabled="0" spacing="5" penColor="#000000" direction="0" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" opacity="1" barWidth="5" labelPlacementMethod="XHeight" minScaleDenominator="0" rotationOffset="270" backgroundAlpha="255" showAxis="1" spacingUnit="MM" penWidth="0" penAlpha="255" lineSizeType="MM" diagramOrientation="Up">
  ...
  <aliases>
    ...
    <alias field="left" name="dist" index="1"/>
    <alias field="top" name="to_x" index="2"/>
    <alias field="right" name="to_y" index="3"/>
    <alias field="bottom" name="to_angle" index="4"/>
  </aliases>
  <defaults>
    <default field="fid" applyOnUpdate="0" expression=""/>
    <default field="left" applyOnUpdate="0" expression=""/>
    <default field="top" applyOnUpdate="0" expression=""/>
    <default field="right" applyOnUpdate="0" expression=""/>
    <default field="bottom" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    <field name="bottom" labelOnTop="1"/>
    <field name="fid" labelOnTop="0"/>
    <field name="left" labelOnTop="1"/>
    <field name="right" labelOnTop="0"/>
    <field name="top" labelOnTop="1"/>
  </labelOnTop>
  <reuseLastValue>
